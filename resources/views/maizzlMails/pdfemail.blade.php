...
<div class="container mx-auto p-6 max-w-lg bg-white border border-gray-300 shadow-md rounded-lg">
  ...
  <div class="user-info mb-6">
    ...
    <p class="text-gray-700"><span class="font-semibold">Role:</span> Administrator</p>
    <p class="text-gray-700"><span class="font-semibold">company:</span> Lionsgeek</p>
    <p class="text-gray-700"><span class="font-semibold">country:</span> Morocco</p>
  </div>
